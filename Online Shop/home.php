									...
									?>
										...
										<div class="product">
											...
											<div class="product-body">
												...
												<h3 class="product-name"><a href="#"><?php echo $row['name']; ?></a></h3>
												<h4 class="product-price">Rp. <?php echo $row['price']; ?>,-</h4>
											...
											<div class="add-to-cart">
												<button class="add-to-cart-btn"><a href="add_cart.php?id=<?php echo $row['id']; ?>" ><i class="fa fa-shopping-cart"></i> add to cart</a></button>
											</div>
										</div>
										<!-- /product -->
										<?php
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="product-body">
										<p class="product-category"><?php echo $row['kategori']; ?></p>
										<h3 class="product-name"><a href="#"><?php echo $row['name']; ?></a></h3>
										<h4 class="product-price">Rp. <?php echo $row['price']; ?>,-<del class="product-old-price">000000</del></h4>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
